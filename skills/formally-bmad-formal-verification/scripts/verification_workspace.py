...
# ///
"""Create Formally BMAD verification report workspace."""
...
STARTER_FILES = {
    ...
    "contradictions.md": "# Contradictions and Overrides\n\n",
...
def create_workspace(module_root: Path, scope: str) -> dict[str, object]:
    ...
    workspace = module_root / "reports" / "verification" / f"{stamp}-{safe_scope}"
    ...
    latest = module_root / "reports" / "latest-verification-summary.md"
    latest.write_text(
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create a Formally BMAD verification report workspace.")
    parser.add_argument("--project-root", required=True, help="Project root directory.")
    parser.add_argument("--module-root", required=True, help="Formally BMAD project state directory.")
    parser.add_argument("--scope", default="whole-model", help="Verification scope label.")
