...
# ///
"""First Breath scaffolding for formally-bmad-agent-steward."""
...
SKILL_NAME = "formally-bmad-agent-steward"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create the Formally BMAD steward sanctum.")
