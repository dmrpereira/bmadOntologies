...
# ///
"""Create Formally BMAD contract-stub companion workspace."""
...
STARTER_FILES = {
    "stubs.md": "# Contract-Bearing Stubs\n\n## Formal Status\n\n",
    "contract-surface.md": "# Contract Surface Mapping\n\n| Contract ID | Target Stub | Placement | Fidelity | Notes |\n| ----------- | ----------- | --------- | -------- | ----- |\n",
    "file-plan.md": "# File and Module Plan\n\n| File / Module | Responsibility | Stub Elements | Notes |\n| ------------- | -------------- | ------------- | ----- |\n",
    "review-checklist.md": "# Stub Review Checklist\n\n- [ ] Signatures match accepted obligations\n- [ ] Contract placement is correct\n- [ ] No business logic was filled in prematurely\n- [ ] Naming and boundaries are acceptable\n",
    "provenance.md": "# Provenance\n\n| Source Contract | Stub Element | Notes |\n| --------------- | ------------ | ----- |\n",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create a Formally BMAD contract-stub companion workspace.")
    parser.add_argument("--project-root", required=True, help="Project root directory.")
    parser.add_argument("--module-root", required=True, help="Formally BMAD project state directory.")
    parser.add_argument("--target", required=True, help="Stub target language and scope.")
