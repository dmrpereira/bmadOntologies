...
# ///
"""Create Formally BMAD contract companion workspace."""
...
STARTER_FILES = {
    ...
    "contract-inventory.md": "# Contract Inventory\n\n| Contract ID | Target Surface | Kind | Notation Family | Faithfulness | Verification Mode | Claim Strength |\n| ----------- | -------------- | ---- | --------------- | ------------ | ----------------- | -------------- |\n",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create a Formally BMAD code-contract companion workspace.")
    parser.add_argument("--project-root", required=True, help="Project root directory.")
    parser.add_argument("--module-root", required=True, help="Formally BMAD project state directory.")
    parser.add_argument("--target", required=True, help="Contract target language and scope.")
